    ...
    <div class="container">
        ...
        <form id="form" role="form" action="/pay" method="post" class="col-sm-7" data-cc-on-file="false"
            ...
            <div class='form-group'>
                ...
                <label class='control-label'>Name on Card</label> <input class='form-control' size='4' type='text' id="card_name" value="Lenny">
...
<?php /**PATH C:\Users\Kid_us\Desktop\Project\Moon\resources\views/Layout/stripe.blade.php ENDPATH**/ ?>