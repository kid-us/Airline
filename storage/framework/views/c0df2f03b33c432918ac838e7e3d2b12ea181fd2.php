        ...
        <div style="margin-left: 250px" class="mt-5 p-4">
            <div id="schedule-page" class="pr-4 pl-4">
                ...
                <form action="<?php echo e(route('create')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <?php if('status'): ?>
                        <p class="text-center text-sucess"><?php echo e(session('status')); ?></p>
                    <?php endif; ?>
                    <div id="manage flights" class="row justify-content-center shadow-lg rounded bg-light p-2">
                        <div class="col-sm-12 col-lg-6 col-xl-6 mt-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="from" id="name" class="form-control rounded <?php $__errorArgs = ['from'];
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-sm-12 col-lg-6 col-xl-6 mt-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="to" id="to" class="form-control rounded <?php $__errorArgs = ['to'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-error-textarea <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-sm-12 col-lg-5 mt-4">
                            ...
                            <input type="date" name="depart-date" id="depart-date" class="form-control rounded <?php $__errorArgs = ['depart-date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-sm-12 col-lg-5 mt-4">
                            ...
                            <input type="date"  name="return-date" id="return-date" class="form-control rounded <?php $__errorArgs = ['return-date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-error-textarea <?php unset($message);
                        ...
                        <div class="col-sm-12 col-lg-2 mt-4">
                            ...
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    ...
                                    <input type="number" name="terminal" id="terminal" class="form-control rounded <?php $__errorArgs = ['terminal'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-error-textarea <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-sm-12 col-lg-6 mt-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="flight-no" id="flight-no" class="form-control rounded <?php $__errorArgs = ['flight-no'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-error-textarea <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-sm-12 col-lg-6 mt-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="travel-time" id="travel-time" class="form-control rounded <?php $__errorArgs = ['travel-time'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-error-textarea <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-sm-12 col-lg-6 mt-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="aircraft" id="aircraft" class="form-control rounded <?php $__errorArgs = ['aircraft'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-error-textarea <?php unset($message);
...
<?php /**PATH C:\Users\Kid_us\Desktop\Project\Moon\resources\views/Manager/man.blade.php ENDPATH**/ ?>