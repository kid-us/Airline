    ...
    <div class="row justify-content-center mt-5" id="admin-login">
        <div class="col-sm-12 col-md-12 colxl-6 col-lg-6 rounded shadow-lg mt-5 p-5 bg-light">
            <form action="#" method="POST" class="text-center">
                <?php echo csrf_field(); ?>
                <img src="<?php echo e(asset('img/clerk.png')); ?>" alt="" width="50px" class="rounded">
                ...
                <div class="input-group">
                    ...
                    <?php if(session('status')): ?>
                        <p class="small text-danger"><?php echo e(session ('status')); ?></p>
                    <?php endif; ?>
                    <input type="email" name="email" class="form-control-plaintext <?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> borer-error <?php unset($message);
...
<?php /**PATH C:\Users\Kid_us\Desktop\Project\Moon\resources\views/Auth/adminlogin.blade.php ENDPATH**/ ?>