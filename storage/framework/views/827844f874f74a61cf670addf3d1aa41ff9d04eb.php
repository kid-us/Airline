    ...
    <div class="container">
        ...
        <div class="row justify-content-center mt-5" id="clerk-login">
            <div class="col-sm-12 col-md-12 colxl-6 col-lg-6 rounded shadow-lg mt-5 p-5 bg-light">
                <form action="<?php echo e(route('login')); ?>" method="POST" class="text-center">
                    <?php echo csrf_field(); ?>
                    <img src="<?php echo e(asset('img/clerk.png')); ?>" alt="" width="50px" class="rounded mb-3">
                    
                    <?php if(session('status')): ?>
                        <p class="small text-danger mb-2 text-center"><?php echo e(session ('status')); ?></p>
                    <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="row justify-content-center mt-5" id="admin-login">
        <div class="col-sm-12 col-md-12 colxl-6 col-lg-6 rounded shadow-lg mt-5 p-5 bg-light">
            <form action="<?php echo e(route('login')); ?>" method="POST" class="text-center">
                <?php echo csrf_field(); ?>
                <img src="<?php echo e(asset('img/admin.png')); ?>" alt="" width="50px" class="rounded mb-3">
                <?php if(session('status')): ?>
                    <p class="small text-danger text-center mb-2"><?php echo e(session ('status')); ?></p>
                <?php endif; ?>
                <div class="input-group">
...
<?php /**PATH C:\Users\Kid_us\Desktop\Project\Moon\resources\views/Auth/userlogin.blade.php ENDPATH**/ ?>