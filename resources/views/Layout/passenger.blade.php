...
<div class="container mt-5">
    <div class="row justify-content-center mt-5">
        ...
        <div class="col-9 adult-forms mt-5">
            <h5> <span id="passenger-type">{{ $user }}</span> passenger </h5>
            <div class="passenger-info p-3">
                <div class="passenger-type">

                    <h5 class="ml-4"> Passengers ⥱
                        <img src="{{ asset('img/adult.png') }}" width="25px"  class="mr-1 ml-2" > Adult:
                        <span id="adult-indicator"></span>
                        <img src="{{ asset('img/child.png') }}" width="25px" class="ml-5 mr-1"> Children:
                        <span id="child-indicator"> </span>
                        <img src="{{ asset("img/infant.png") }}" class="ml-5 mr-1" width="25px">Infant:
                        <span id="infant-indicator""></span>
                        <span id="all-indicator" class="hidden"> </span>
                        <span id="token-values" class="hidden"></span>
                        <span> <a href="#" id="info-link" class="rise-shake float-right mr-4 pt-3"><img class="rise-shake" src="{{ asset('img/info.png') }}" width="20px" alt=""></a></span>
                    </h5>
                ...
                <form action="/passenger/check" method="post">
                    ...
                    <div class="sumbitted-form mb-5 hidden">
                        <input type="text" name="travel" value="{{ $user }}">
                    </div>
...
<script src="{{ asset('Js/cookies/getPassengerCookie.js') }}"></script>
<script src="{{ asset("Js/cookies/validation.js") }}"></script>
</body>
</html>
