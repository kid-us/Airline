        ...
        <div class="container">
            ...
            <div class="row mb-5">
                <div class="col-xs-12 col-sm-12 col-md-7 col-lg-5 col-xl-8 mt-3 text-light">
                    <h1 class="text-shadow">{{ $site->slogan }}</h1>
                    ...
                    {{-- <a href="#" class="btn btn-dark mt-5 w-25 rounded-lg shadow-lg">Try Now</a> --}}
                </div>
            </div>

            <div class="rounded shadow-lg p-3 w-100 flight-form bg-light">
            {{-- Hidden in md xl and lg --}}
                <div class=" d-block d-md-none ">
                    ...
                    <form action="#" class="mt-2 rounded p-4 w-100 mt-2">
                        ...
                        {{-- Booking container in small devices --}}
                        ...
                        {{-- Check-in container in small devices --}}
        ...
        {{-- end small device --}}
                ...
                <div class="d-none d-md-block">
                    ...
                    <div id="book-page">
                        ...
                        {{-- ticket-type
                        <a  id="class-link" class="default-link ml-5">Economy </a> <span class="fas fa-caret-down"></span> --}}
                        {{-- flight container --}}
                        <p class="pl-3 pt-2 mt-3">Hi, where would you like to go? Select your Flight</p>
                            <div class="form-inline input-group mt-3">
                                ...
                                <input type="text" id="from" name="from" placeholder="From" class="form-control-plaintext mr-4 @error('from') border-error @enderror" value="{{ old('from') }}">

                                <div class="input-group-prepend">
                                    <span class="input-group-text fas fa-plane-arrival"></span>
                                </div>
                                <input type="text" id="to" placeholder="To" name="to" class="form-control-plaintext mr-4 @error('to') border-error @enderror" value="{{ old('to') }}">


                                <input type="date" name="depart-date" id="depart-date" class="form-control date-input mr-3 rounded @error('depart-date') error @enderror" title="Depart Date" value="{{ old('depart-date') }}">


                                <input type="date" name="return-date" id="return-date" class="form-control date-input mr-3 rounded @error('return-date') error @enderror" title="Return Date" value="{{ old('return-date') }}" hidden>
                        ...
                        <div id="booking-page" class="hidden">
                            <form action="/flight/booking" method="POST" class="mt-1 ml-2 rounded p-3">
                                ...
                                <div class="form-inline input-group" >
                                    ...
                                    <input type="email" name="email" placeholder="Email" class="form-control-plaintext mr-4 @error('email') border-error @enderror">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text fas fa-pen-alt"></span>
                                    </div>
                                    <input type="text" placeholder="Last Name" name="last-name" class="form-control-plaintext mr-4 @error('last-name') border-error @enderror">
                        ...
                        <div id="flight-info-page" class="hidden">
                            <form action="/flight/status" method="POST" class="mt-1 ml-2 rounded p-3">
                                ...
                                <input type="text" name="from" placeholder="Origin" class="form-control-plaintext mr-4 @error('from') border-error @enderror">
                                <div class="input-group-prepend">
                                    <span class="input-group-text fas fa-plane-arrival"></span>
                                </div>
                                <input type="text" id="destination" placeholder="Destination" name="to" class="form-control-plaintext mr-4 @error('to') border-error @enderror">
                                <input type="date" name="date" class="form-control date-input mr-3 rounded @error('date') border-error @enderror" title="Depart Date">
                        ...
                        <div id="check-in-page" class="hidden">
                            <form action="/flight/check-in" method="POST" class="mt-1 ml-2 rounded p-3">
                                ...
                                <div class="form-inline input-group" >
                                    ...
                                    <input type="text" id="ticket-no" name="ticket-no" placeholder="Ticket Number" class="form-control-plaintext mr-4 @error('ticket-no') border-error @enderror">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text fas fa-pen-alt"></span>
                                    </div>
                                    <input type="text" id="last-name" placeholder="Last Name" name="last-name" class="form-control-plaintext mr-4 @error('last-name') border-error @enderror"">
                    ...
                    {{-- <div id="class-modal" class="class-view rounded shadow-lg hidden">
                        <button id="economy-value" class="w-100 modal-btn text-dark">Economy</button>
                        <button id="business-value" class="w-100 modal-btn text-dark">Business</button>
                    </div> --}}

                    {{-- fLIGHT FROM MODAL --}}

                </div> {{-- end large devices --}}
            </div>
                    ...
                    <div class="col-sm-12 col-md-3 col-lg-4 col-xl-4 mb-3 mt-5">
                        <div class="rounded shadow p-4  bg-light">
                            <a href="#" class="text-dark" style="text-decoration: none">
                                <div class="row">
                                    <div class="col-3">
                                        <img src="{{ asset('img/destination.png') }}" alt="" width="30px">
                                    </div>
                                    <div class="col-9">
                    ...
                    <div class="col-sm-12 col-md-3 col-lg-4 col-xl-4 mb-3 mt-5">
                        <div class="rounded shadow p-4  bg-light">
                            <a href="#" class="text-dark" style="text-decoration: none">
                                <div class="row">
                                    <div class="col-3">
                                        <img src="{{ asset('img/advisor.png') }}" alt="" width="30px">
                                    </div>
                                    <div class="col-9">
                    ...
                    <div class="col-sm-12 col-md-3 col-lg-4 col-xl-4 mb-3 mt-5">
                        <div class="rounded shadow p-4  bg-light">
                            <a href="#" class="text-dark" style="text-decoration: none">
                                <div class="row">
                                    <div class="col-3">
                                        <img src="{{ asset('img/covid.png') }}" alt="" width="30px">
                                    </div>
                                    <div class="col-9">
            ...
            <div class="d-none d-md-block mt-4">
                ...
                <form action="/flight/selected" method="post"  id="domestic-page">
                    ...
                    <div class="input-group w-25">
                        ...
                        <input type="text" name="departure-airport" placeholder="From" class="form-control-plaintext  mt-2 mb-4 w-50 @error('departure-airpor') border-error @enderror">
                    </div>

                    <div class="row">
                            <div id="img-container-1" class="col-md-6 col-lg-6 col-xl-6 mb-3">
                                <img id="img-1" src="{{ asset('img/Domestic/Addis Abeba.jpg') }}" class="border rounded img w-100 shadow-lg" alt="Addis Abeba" height="518px">
                        ...
                        <div class="col-md-6 col-lg-6 col-xl-6">
                            <div class="row">
                                <div id="img-container-2" class="col-md-6 col-lg-6 col-xl-6">
                                    {{-- <form action="/"></form> --}}
                                    <img id="img-2" src="{{ asset('img/Domestic/Gondar.jpg') }}" class="img w-100 shadow-lg rounded border" alt="Gondar" height="250px">
                                ...
                                <div id="img-container-3" class="col-md-6 col-lg-6 col-xl-6">
                                    <img id="img-3" src="{{ asset('img/Domestic/Lalibela.jpg') }}" class="border rounded img w-100 shadow-lg" alt="Lalibela" height="250px">
                                ...
                                <div id="img-container-4" class="col-md-6 col-lg-6 col-xl-6 mt-3">
                                    <img id="img-4" src="{{ asset('img/Domestic/Axum.jpg') }}" class="border rounded img w-100 shadow-lg" alt="Axum" height="250px">
                                ...
                                <div id="img-container-5" class="col-md-6 col-lg-6 col-xl-6 mt-3">
                                    <img id="img-5" src="{{ asset('img/Domestic/Semera.jpg') }}" class="border rounded img w-100 shadow-lg" alt="Semera Afar" height="250px">
                        ...
                        <div id="img-container-6" class="col-md-3 col-lg-3 col-xl-3">
                            <img id="img-6" src="{{ asset('img/Domestic/Mekele.jpg') }}" class="border rounded img w-100 shadow-lg" alt="Mekele" height="250px">
                        ...
                        <div id="img-container-7" class="col-md-3 col-lg-3 col-xl-3">
                            <img id="img-7" src="{{ asset('img/Domestic/Harar.jpg') }}" class="border rounded img w-100 shadow-lg" alt="Harar" height="250px">
                        ...
                        <div id="img-container-8" class="col-md-6 col-xl-6 col-xl-6">
                            <img id="img-8" src="{{ asset('img/Domestic/Bahirdar.jpg') }}" class="border rounded img w-100 shadow-lg" alt="Bahirdar" height="250px">
                ...
                <form action="#" method="post" class="hidden" id="africa-page">
                    ...
                    <div class="row">
                        <div id="af-img-container-1" class="col-md-6 col-lg-6 col-xl-6 mb-3">
                            <img id="af-img-1" src="{{ asset('img/Africa/Accra.jpg') }}" class="border rounded img w-100 shadow-lg" alt="Accra" height="518px">
                        ...
                        <div class="col-md-6 col-lg-6 col-xl-6">
                            <div class="row">
                                <div id="af-img-container-2" class="col-md-6 col-lg-6 col-xl-6">
                                    <img id="af-img-2" src="{{ asset('img/Africa/Lalibela.jpg') }}" class="img w-100 shadow-lg rounded border" height="250px" alt="Lalibela">
                                ...
                                <div id="af-img-container-3" class="col-md-6 col-lg-6 col-xl-6">
                                    <img id="af-img-3" src="{{ asset('img/Africa/Casablanca.jpg') }}" class="border rounded img w-100 shadow-lg" height="250px" alt="Casablanca">
                                ...
                                <div id="af-img-container-4" class="col-md-6 col-lg-6 col-xl-6 mt-3">
                                    <img id="af-img-4" src="{{ asset('img/Africa/Nairobbi.jpg') }}" class="border rounded img w-100 shadow-lg" height="250px" alt="Nairobbi">
                                ...
                                <div id="af-img-container-5" class="col-md-6 col-lg-6 col-xl-6 mt-3">
                                    <img id="af-img-5" src="{{ asset('img/Africa/Cairo.jpg') }}" class="border rounded img w-100 shadow-lg" height="250px" alt="Cairo">
                        ...
                        <div id="af-img-container-6" class="col-md-3 col-lg-3 col-xl-3">
                            <img id="af-img-6" src="{{ asset('img/Africa/tunis.jpg') }}" class="border rounded img w-100 shadow-lg" height="250px" alt="Tunis">
                        ...
                        <div id="af-img-container-7" class="col-md-3 col-lg-3 col-xl-3">
                            <img id="af-img-7" src="{{ asset('img/Africa/Johannesburg.jpg') }}" class="border rounded img w-100 shadow-lg" height="250px" alt="Johannesburg">
                        ...
                        <div id="af-img-container-8" class="col-md-6 col-xl-6 col-xl-6">
                            <img id="af-img-8" src="{{ asset('img/Africa/asmara.jpg') }}" class="border rounded img w-100 shadow-lg" height="250px" alt="Asmara">
                ...
                <form action="#" method="" id="america-page" class="hidden">
                    ...
                    <div class="row">
                        <div id="ame-img-container-1" class="col-md-6 col-lg-6 col-xl-6 mb-3">
                            <img id="ame-img-1" src="{{ asset('img/America/Rio de Jinero.jpg') }}" class="border rounded img w-100 shadow-lg" alt="Rio de Jinero" height="518px">
                        ...
                        <div class="col-md-6 col-lg-6 col-xl-6">
                            <div class="row">
                                <div id="ame-img-container-2" class="col-md-6 col-lg-6 col-xl-6">
                                    <img id="ame-img-2" src="{{ asset('img/America/Canada.jpg') }}" class="img w-100 shadow-lg rounded border" alt="Canada" height="250px">
                                ...
                                <div id="ame-img-container-3" class="col-md-6 col-lg-6 col-xl-6">
                                    <img id="ame-img-3" src="{{ asset('img/America/Mexico City.jpg') }}" class="border rounded img w-100 shadow-lg" alt="Mexico City" height="250px">
                                ...
                                <div id="ame-img-container-4" class="col-md-6 col-lg-6 col-xl-6 mt-3">
                                    <img id="ame-img-4" src="{{ asset('img/America/Machu Picchu.jpg') }}" class="border rounded img w-100 shadow-lg" height="250px" alt="Machu Picchu">
                                ...
                                <div id="ame-img-container-5" class="col-md-6 col-lg-6 col-xl-6 mt-3">
                                    <img id="ame-img-5" src="{{ asset('img/America/Washington Dc.jpg') }}" class="border rounded img w-100 shadow-lg" alt="Washington Dc" height="250px">
                        ...
                        <div id="ame-img-container-6" class="col-md-3 col-lg-3 col-xl-3">
                            <img id="ame-img-6" src="{{ asset('img/America/Bogota.jpg') }}" class="border rounded img w-100 shadow-lg" alt="Bogota" height="250px">
                        ...
                        <div id="ame-img-container-7" class="col-md-3 col-lg-3 col-xl-3">
                            <img id="ame-img-7" src="{{ asset('img/America/Buenos Aires.jpg') }}" class="border rounded img w-100 shadow-lg" alt="Buenos Aires" height="250px">
                        ...
                        <div id="ame-img-container-8" class="col-md-6 col-xl-6 col-xl-6">
                            <img id="ame-img-8" src="{{ asset('img/America/New York.jpg') }}" class="border rounded img w-100 shadow-lg" alt="New York" height="250px">
                ...
                <form action="#" method="" id="europe-page" class="hidden">
                    ...
                    <div class="row">
                        <div id="eu-img-container-1" class="col-md-6 col-lg-6 col-xl-6 mb-3">
                            <img id="eu-img-1" src="{{ asset('img/Europe/Paris.jpg') }}" class="border rounded img w-100 shadow-lg" alt="Paris" height="518px">
                        ...
                        <div class="col-md-6 col-lg-6 col-xl-6">
                            <div class="row">
                                <div id="eu-img-container-2" class="col-md-6 col-lg-6 col-xl-6">
                                    <img id="eu-img-2" src="{{ asset('img/Europe/London.jpg') }}" class="img w-100 shadow-lg rounded border" alt="London" height="250px">
                                ...
                                <div id="eu-img-container-3" class="col-md-6 col-lg-6 col-xl-6">
                                    <img id="eu-img-3" src="{{ asset('img/Europe/Amsterdam.jpg') }}" class="border rounded img w-100 shadow-lg" alt="Amsterdam" height="250px">
                                ...
                                <div id="eu-img-container-4" class="col-md-6 col-lg-6 col-xl-6 mt-3">
                                    <img id="eu-img-4" src="{{ asset('img/Europe/Vienna.jpg') }}" class="border rounded img w-100 shadow-lg" alt="Vienna" height="250px">
                                ...
                                <div id="eu-img-container-5" class="col-md-6 col-lg-6 col-xl-6 mt-3">
                                    <img id="eu-img-5" src="{{ asset('img/Europe/Barcelona.jpg') }}" class="border rounded img w-100 shadow-lg" alt="Barcelona" height="250px">
                        ...
                        <div id="eu-img-container-6" class="col-md-3 col-lg-3 col-xl-3">
                            <img id="eu-img-6" src="{{ asset('img/Europe/Prague.jpg') }}" class="border rounded img w-100 shadow-lg" alt="Prague" height="250px">
                        ...
                        <div id="eu-img-container-7" class="col-md-3 col-lg-3 col-xl-3">
                            <img id="eu-img-7" src="{{ asset('img/Europe/Istanbul.jpg') }}" class="border rounded img w-100 shadow-lg" alt="Istanbul" height="250px">
                        ...
                        <div id="eu-img-container-8" class="col-md-6 col-xl-6 col-xl-6">
                            <img id="eu-img-8" src="{{ asset('img/Europe/Rome.jpg') }}" class="border rounded img w-100 shadow-lg" alt="Rome" height="250px">
                ...
                <form action="#" method="" id="asia-page" class="hidden">
                    ...
                    <div class="row">
                        <div id="as-img-container-1" class="col-md-6 col-lg-6 col-xl-6 mb-3">
                            <img id="as-img-1" src="{{ asset('img/Asia/Dubai.jpg') }}" class="border rounded img w-100 shadow-lg" alt="Dubai" height="518px">
                        ...
                        <div class="col-md-6 col-lg-6 col-xl-6">
                            <div class="row">
                                <div id="as-img-container-2" class="col-md-6 col-lg-6 col-xl-6">
                                    <img id="as-img-2" src="{{ asset('img/Asia/Delhi.jpg') }}" class="img w-100 shadow-lg rounded border" alt="Delhi" height="250px">
                                ...
                                <div id="as-img-container-3" class="col-md-6 col-lg-6 col-xl-6">
                                    <img id="as-img-3" src="{{ asset('img/Asia/Kuala Lampur.jpg') }}" class="border rounded img w-100 shadow-lg" alt="Kuala Lampur" height="250px">
                                ...
                                <div id="as-img-container-4" class="col-md-6 col-lg-6 col-xl-6 mt-3">
                                    <img id="as-img-4" src="{{ asset('img/Asia/Seoul.jpg') }}" class="border rounded img w-100 shadow-lg" alt="Seoul" height="250px">
                                ...
                                <div id="as-img-container-5" class="col-md-6 col-lg-6 col-xl-6 mt-3">
                                    <img id="as-img-5" src="{{ asset('img/Asia/Bankok.jpg') }}" class="border rounded img w-100 shadow-lg" alt="Bankok" height="250px">
                        ...
                        <div id="as-img-container-6" class="col-md-3 col-lg-3 col-xl-3">
                            <img id="as-img-6" src="{{ asset('img/Asia/Singapore.jpg') }}" class="border rounded img w-100 shadow-lg" alt="Singapore" height="250px">
                        ...
                        <div id="as-img-container-7" class="col-md-3 col-lg-3 col-xl-3">
                            <img id="as-img-7" src="{{ asset('img/Asia/Tokyo.jpg') }}" class="border rounded img w-100 shadow-lg" alt="Tokyo" height="250px">
                        ...
                        <div id="as-img-container-8" class="col-md-6 col-xl-6 col-xl-6">
                            <img id="as-img-8" src="{{ asset('img/Asia/Beijing.jpg') }}" class="border rounded img w-100 shadow-lg" alt="Beijing" height="250px">
                ...
                <div class="row">
                    <div id="md-img-container-1" class="col-md-6 col-lg-6 col-xl-6 mb-3">
                        <img id="md-img-1" src="{{ asset('img/Middle/Abu Dahbi.jpg')}}" class="border rounded img w-100 shadow-lg" alt="Abu Dahbi" height="518px">
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-6">
                        <div class="row">
                            <div id="md-img-container-2" class="col-md-6 col-lg-6 col-xl-6">
                                <img id="md-img-2" src="{{ asset('img/Middle/Jerusalem.jpg') }}" class="img w-100 shadow-lg rounded border" alt="Jerusalem" height="250px">
                            ...
                            <div id="md-img-container-3" class="col-md-6 col-lg-6 col-xl-6">
                                <img id="md-img-3" src="{{ asset('img/Middle/Petra.jpg') }}" class="border rounded img w-100 shadow-lg" alt="Petra" height="250px">
                            ...
                            <div id="md-img-container-4" class="col-md-6 col-lg-6 col-xl-6 mt-3">
                                <img id="md-img-4" src="{{ asset('img/Middle/Beirut.jpg') }}" class="border rounded img w-100 shadow-lg" alt="Beirut" height="250px">
                            ...
                            <div id="md-img-container-5" class="col-md-6 col-lg-6 col-xl-6 mt-3">
                                <img id="md-img-5" src="{{ asset('img/Middle/Manama.jpg') }}" class="border rounded img w-100 shadow-lg" alt="Manama" height="250px">
                    ...
                    <div id="md-img-container-6" class="col-md-3 col-lg-3 col-xl-3">
                        <img id="md-img-6" src="{{ asset('img/Middle/Kuwait.jpg') }}" class="border rounded img w-100 shadow-lg" alt="Kuwait" height="250px" alt="">
                    ...
                    <div id="md-img-container-7" class="col-md-3 col-lg-3 col-xl-3">
                        <img id="md-img-7" src="{{ asset('img/Middle/Salalah.jpg') }}" class="border rounded img w-100 shadow-lg" alt="Salalah" height="250px" alt="">
                    ...
                    <div id="md-img-container-8" class="col-md-6 col-xl-6 col-xl-6">
                        <img id="md-img-8" src="{{ asset('img/Middle/Doha.jpg') }}" class="border rounded img w-100 shadow-lg" height="250px" alt="Doha">
            ...
            <div id="arrow-container-1" class="col-sm-12 col-md-4 col-lg-4 col-xl-4 mb-3 mt-5">
                <div class="rounded shadow p-3  bg-light">
                    <a href="#" class="text-dark" style="text-decoration: none">
                        ...
                        <div class="row">
                            <div class="col-3">
                                <img src="{{ asset('img/travel.png') }}" alt="" width="50px" class="m-3">
                            </div>
                            <div class="col-9">
            ...
            <div id="arrow-container-2" class="col-sm-12 col-md-4 col-lg-4 col-xl-4 mb-3 mt-5">
                <div class="rounded shadow p-3  bg-light">
                    <a href="#" class="text-dark" style="text-decoration: none">
                        ...
                        <div class="row">
                            <div class="col-3">
                                <img src="{{ asset('img/bagagge.png') }}" alt="" width="50px" class="m-3">
                            </div>
                            <div class="col-9">
                                <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Iure eaque suscipit similique aut ipsum illo ipsam, nemo dolorum tempore laboriosam dicta nihil!</p>
                            </div>
            ...
            <div id="arrow-container-3" class="col-sm-12 col-md-4 col-lg-4 col-xl-4 mb-3 mt-5">
                <div class="rounded shadow p-3  bg-light">
                    <a href="#" class="text-dark" style="text-decoration: none">
                        ...
                        <div class="row">
                            <div class="col-3">
                                <img src="{{ asset('img/destination.png') }}" alt="" width="50px" class="m-3">
                            </div>
                            <div class="col-9">
                                <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Iure eaque suscipit similique aut ipsum illo ipsam, nemo dolorum tempore laboriosam dicta nihil!</p>
                            </div>
    ...
    {{-- on midium large and Extra Large devices --}}
    ...
    <div class="container">
        ...
        <div class="row justify-content-center mt-3">
            ...
            <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                ...
                <hr style="background-color: #03422d">
                <p> {{ date('D-d-M', strtotime($news->created_at)) }} </p>
                <p> {{ $news->news }} </p>
                @endforeach
            </div>
        </div>
